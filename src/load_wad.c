...
typedef enum
{
    ...
    THING__BIG_HP = 2012,
    THING__QUAD_DAMAGE_ORB = 2013,
    THING__GODMODE_ORB = 2022,
    THING__LAMP = 2028,
    THING__ROCKETS = 2046,
    THING__AMMO = 2048,
    THING__IMP = 3001,
    ...
    THING__TELEPORTER = 10029,
    THING__STALAG0 = 10030,
    THING__STALAG1 = 10031,
    THING__STALAG2 = 10032,
    THING__WINTER_TREE0 = 10033,
    THING__WINTER_TREE1 = 10034,
    THING__WINTER_TREE2 = 10035,
...
static void Load_Sectors(mapsector_t* msectors, int num, Texture* sky_texture, Map* map)
{
    ...
    for (int i = 0; i < num; i++)
    {
        ...
        //check if special
        if (os->special == SECTOR_SPECIAL__SECRET)
        {
...
static void Load_Things(mapthing_t* mthings, int num, Map* map)
{
    ...
    for (int i = 0; i < num; i++)
    {
        ...
        case THING__TELEPORTER:
        {
            type = OT__THING;
            sub_type = SUB__THING_TELEPORTER;
            break;
        }
        case THING__STALAG0:
        {
            type = OT__THING;
            sub_type = SUB__THING_STALAG0;
            break;
        }
        case THING__STALAG1:
        {
            type = OT__THING;
            sub_type = SUB__THING_STALAG1;
        ...
        {
            type = OT__THING;
            sub_type = SUB__THING_STALAG2;
            break;
        }
        case THING__WINTER_TREE0:
        {
            type = OT__THING;
            sub_type = SUB__THING_WINTER_TREE0;
            break;
        }
        case THING__WINTER_TREE1:
        {
            type = OT__THING;
            sub_type = SUB__THING_WINTER_TREE1;
            break;
        }
        case THING__WINTER_TREE2:
        {
            type = OT__THING;
            sub_type = SUB__THING_WINTER_TREE2;
            break;
        }
        case THING__WINTER_TREE3:
        {
            type = OT__THING;
            sub_type = SUB__THING_WINTER_TREE3;
            break;
        }
        case THING__ROCK0:
        {
            type = OT__THING;
            sub_type = SUB__THING_ROCK0;
            break;
        }
        case THING__ROCK1:
        {
        ...
        case THING__QUAD_DAMAGE_ORB:
        {
            type = OT__PICKUP;
            sub_type = SUB__PICKUP_QUAD_DAMAGE;
            break;
        }
        case THING__GODMODE_ORB:
        {
            type = OT__PICKUP;
